...
using Inta.ERP.Authorization.ViewModels;
using System.Security.Claims;
using Inta.ERP.Authorization.ViewModels.Authorization;
using Microsoft.AspNetCore.Authorization;
using Inta.ERP.Authorization.Helpers;
using Microsoft.IdentityModel.Tokens;

namespace Inta.ERP.Authorization.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        UserManager<User> userManager, ILogger<AuthorizationController> logger)
        {
